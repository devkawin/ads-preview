...
function animation(){
	...
	TweenMax.from("#copyparent2", 0.5, {x:400,delay:1});
	...
	TweenMax.from("#frame1", 0.5, {opacity:1, x:50, delay:6});
	TweenMax.to("#imgparent1", 3, {y:-100, delay:7});
	TweenMax.to("#frame1", 0.5, {x:400, delay:11});
	
	TweenMax.from("#frame2", 0.5, {opacity:1, x:50, delay:11});
	TweenMax.to("#imgparent2", 3, {y:-100, delay:12});
	TweenMax.to("#frame2", 0.5, {x:400, delay:15});
	
	TweenMax.from("#frame3", 0.5, {opacity:1, x:50, delay:15});
	TweenMax.to("#imgparent3", 3, {y:-100, delay:16});
	TweenMax.to("#frame3", 0.5, {x:400, delay:19});
	
	TweenMax.to(".end", 0.5, {opacity:1, delay:19});
	TweenMax.to("#promoparent", 0.5, {bottom:0, scale:1,delay:20});
	TweenMax.from("#ctaparent", 0.5, {x:-400, ease:Bounce.easeOut, delay:21});
	eventshandler();
}
