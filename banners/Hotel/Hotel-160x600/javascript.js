...
function animation(){
	...
	TweenMax.from("#copyparent1", 0.5, {x:-150,delay:1});
	TweenMax.from("#copyparent2", 0.5, {x:150,delay:1});
	TweenMax.from("#promoparent", 0.5, {scale:0, opacity:1,delay:2});
	
	TweenMax.to("#copyparent1", 0.5, {x:-150,delay:5});
	TweenMax.to("#copyparent2", 0.5, {scale:0, y:20,delay:5});
	TweenMax.to("#promoparent", 0.5, {scale:0, opacity:1,delay:5});
	
	TweenMax.from("#frame1", 0.5, {opacity:1, x:160, delay:6});
	TweenMax.to("#imgparent1", 3, {x:-160, delay:7});
	TweenMax.to("#frame1", 0.5, {y:600, delay:11});
	
	TweenMax.from("#frame2", 0.5, {opacity:1, x:160, delay:11});
	TweenMax.to("#imgparent2", 3, {x:-160, delay:12});
	TweenMax.to("#frame2", 0.5, {y:600, delay:15});
	
	TweenMax.from("#frame3", 0.5, {opacity:1, x:160, delay:15});
	TweenMax.to("#imgparent3", 3, {x:-160, delay:16});
	TweenMax.to("#frame3", 0.5, {y:600, delay:19});
	
	TweenMax.to(".end", 0.5, {opacity:1, delay:19});
	TweenMax.to("#promoparent", 0.5, {bottom:80, scale:1,delay:20});
	TweenMax.from("#ctaparent", 0.5, {x:-150, ease:Bounce.easeOut, delay:21});
	eventshandler();
}
