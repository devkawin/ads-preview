...
function animation(){
	...
	TweenMax.from("#copyparent2", 0.5, {x:300,delay:1});
	...
	TweenMax.from("#frame1", 0.5, {opacity:1, x:70, delay:6});
	TweenMax.to("#imgparent1", 3, {x:-70, delay:7});
	TweenMax.to("#frame1", 0.5, {y:250, delay:11});
	
	TweenMax.from("#frame2", 0.5, {opacity:1, x:70, delay:11});
	TweenMax.to("#imgparent2", 3, {x:-70, delay:12});
	TweenMax.to("#frame2", 0.5, {y:250, delay:15});
	
	TweenMax.from("#frame3", 0.5, {opacity:1, x:70, delay:15});
	TweenMax.to("#imgparent3", 3, {x:-70, delay:16});
	TweenMax.to("#frame3", 0.5, {y:250, delay:19});
