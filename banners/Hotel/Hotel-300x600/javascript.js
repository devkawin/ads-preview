...
function animation(){
	...
	TweenMax.from("#copyparent1", 0.5, {x:-250,delay:1});
	TweenMax.from("#copyparent2", 0.5, {x:250,delay:1});
	TweenMax.from("#promoparent", 0.5, {scale:0, opacity:1,delay:2});
	
	TweenMax.to("#copyparent1", 0.5, {x:-250,delay:5});
	...
	TweenMax.from("#ctaparent", 0.5, {x:-250, ease:Bounce.easeOut, delay:21});
	eventshandler();
}
