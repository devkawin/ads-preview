...
function animation(){
	...
	TweenMax.from("#copyparent2", 1, {x:110, delay:1.5});
	TweenMax.from("#pricecopyparent", 0.5, {rotation:360, scale:0, delay:2.5});
	TweenMax.from("#copytxt31", 0.5, {x:100, delay:3.5});
	TweenMax.from("#copytxt32", 0.5, {x:100, delay:3.7});
	TweenMax.from("#copytxt33", 0.5, {x:100, delay:3.9});
