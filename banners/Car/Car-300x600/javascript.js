...
function animation(){
	...
	TweenMax.from("#bgimgparent", 1, {x:-150, delay:0.5});
	TweenMax.from("#copyparent1", 1, {y:-50, delay:0.5});
	TweenMax.from("#logoparent", 1, {y:50, delay:0.5});
	TweenMax.from("#copyparent2", 1, {x:250, delay:1.5});
	TweenMax.from("#pricecopyparent", 0.5, {rotation:360, scale:0, delay:2.5});
	TweenMax.from("#copytxt31", 0.5, {x:200, delay:3.5});
	TweenMax.from("#copytxt32", 0.5, {x:200, delay:3.7});
	TweenMax.from("#copytxt33", 0.5, {x:200, delay:3.9});
...
function eventshandler(){
	$("#container").mouseover(function(){
		$("#ctaparent").css({"background-color": "#fff","transition": "0.1s linear 0s", "border":"2px solid #EE3936"});
