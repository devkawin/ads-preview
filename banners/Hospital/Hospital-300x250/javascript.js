...
function animation(){
	...
	setTimeout(function(){
		...
		$("#logoparent").css({"transform": "translate(0px, -90px) scale(0.5)", "transition":"0.5s linear 1s"});
	...
	setTimeout(function(){
	$("#copyparent1").css({"transform": "translate(-400px, -12px)", "transition":"0.5s linear 3s"});
	$("#copyparent2").css({"transform": "translate(-400px, -1px)", "transition":"0.5s linear 3.5s"});
	},4500);
	...
	$("#frame3").css({"transform": "translate(-400px, 0px)", "transition":"0.5s linear 1s"});
	...
	$("#logoparent").css({"transform": "translate(0px, -60px) scale(0.7)", "transition":"0.5s linear 1s"});
	},13500);
