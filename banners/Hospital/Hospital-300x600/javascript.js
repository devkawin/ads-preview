$(document).ready(function(){
	...
	$("#copytxt1").text("Heart Health Super Hospitals!");
...
function animation(){
	...
	setTimeout(function(){
		...
		$("#logoparent").css({"transform": "translate(0px, -200px) scale(0.9)", "transition":"0.5s linear 1s"});
		$("#copyparent1").css({"opacity": "1", "transform": "translate(0px, -12px)", "transition":"0.5s linear 2s"});
		$("#copyparent2").css({"opacity": "1", "transform": "translate(0px, -1px)", "transition":"0.5s linear 3s"});
	},500);
	
	setTimeout(function(){
	$("#copyparent1").css({"transform": "translate(-500px, -12px)", "transition":"0.5s linear 3s"});
	$("#copyparent2").css({"transform": "translate(-500px, -1px)", "transition":"0.5s linear 3.5s"});
	},4500);
	...
	$("#frame3").css({"transform": "translate(-500px, 0px)", "transition":"0.5s linear 1s"});
	...
	$("#logoparent").css({"transform": "translate(0px, -170px) scale(0.8)", "transition":"0.5s linear 1s"});
	},13500);
