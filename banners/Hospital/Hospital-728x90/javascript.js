...
function animation(){
	...
	setTimeout(function(){
		...
		$("#logoparent").css({"transform": "translate(280px, 0px) scale(0.8)", "transition":"0.5s linear 1s"});
	...
	setTimeout(function(){
	$("#copyparent1").css({"transform": "translate(-600px, -12px)", "transition":"0.5s linear 3s"});
	$("#copyparent2").css({"transform": "translate(-600px, -1px)", "transition":"0.5s linear 3.5s"});
	},4500);
	...
	$("#frame3").css({"transform": "translate(-600px, 0px)", "transition":"0.5s linear 1s"});
	...
	$("#logoparent").css({"transform": "translate(250px, 0px) scale(0.7)", "transition":"0.5s linear 1s"});
	},13500);
